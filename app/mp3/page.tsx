...
export default function PageMp3() {
    ...
    <main style={{ padding: 24, fontFamily: "system-ui, -apple-system" }}>
      ...
      >
        ...
        <p style={{ marginTop: 8, marginBottom: 8 }}>
          このテストでは、ローカルの音源（/audio/sample.mp3）を使用しています。
        </p>
      ...
      <section style={grid}>
        <div style={box}>
          ...
          <div style={half}>
            <AutoPlayAudio src={localAudioSrc} />
          </div>
        </div>
        ...
        <div style={box}>
          <h2>2) 初回クリック → 再生開始</h2>
          <div style={half}>
            <AutoPlayAudioPrimeStart src={localAudioSrc} />
          </div>
        </div>
        ...
        <div style={box}>
          <h2>5) ボタンクリック後再生</h2>
          <div style={half}>
            <AutoPlayAudioButtonStart src={localAudioSrc} />
          </div>
        </div>
      </section>
    </main>
